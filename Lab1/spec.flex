...
//integer
0{octal_array} | 0x{hexa_array} | {digit_array}  { return new Yytoken( sym.CONST, yytext(), yyline, yycolumn, yychar ); }

//real
({digit_array}\.{digit_array}?(E[+-]?{digit_array})?) | (\.{digit_array}(E[+-]?{digit_array})?) { return new Yytoken( sym.CONST, yytext(), yyline, yycolumn, yychar ); }
